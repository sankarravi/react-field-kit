...
var PhoneField = (function (_TextField) {
  _inherits(PhoneField, _TextField);

  function PhoneField() {
    _classCallCheck(this, PhoneField);

    _get(Object.getPrototypeOf(PhoneField.prototype), 'constructor', this).apply(this, arguments);
  }
